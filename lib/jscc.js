...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(require('./jscc/global'),
                                 require('./jscc/io/ioNode'), require('./jscc/first'),
                                 require('./jscc/printtab'), require('./jscc/tabgen'),
                                 require('./jscc/util'),
                                 require('./jscc/integrity'),
                                 require('./jscc/lexdbg'), require('./jscc/parse'), require("./jscc/log/logNode"),
                                 require('./jscc/enums/LOG_LEVEL'), require('./jscc/enums/EXEC'),
                                 require('./jscc/lexdfa'),
