...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './log/log', './enums/SYM'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports =
            factory(require('./global'), require('./log/logNode'), require('./enums/SYM'));
    } else {
        root.integrity = factory(root.global, root.log, root.SYM);
    }
