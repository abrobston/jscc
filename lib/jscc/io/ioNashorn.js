...
(function(root, factory) {
     ...
     */
    var FileReader = /** @type {function(new:java.io.FileReader, (java.io.File|string))}} */ (Java.type("java.io.FileReader"));
    /**
     * @type {function(new:java.io.InputStreamReader, java.io.InputStream)}
     */
    var InputStreamReader = /** @type {function(new:java.io.InputStreamReader, java.io.InputStream)} */ (Java.type("java.io.InputStreamReader"));
    /**
     * @type {function(new:java.io.BufferedReader, (java.io.FileReader|java.io.InputStreamReader))}
     */
    var BufferedReader = /** @type {function(new:java.io.BufferedReader, (java.io.FileReader|java.io.InputStreamReader))} */ (Java.type("java.io.BufferedReader"));
    /**
     ...
     */
    var BufferedWriter = /** @type {function(new:java.io.BufferedWriter, java.io.FileWriter)} */ (Java.type("java.io.BufferedWriter"));
    /**
     * @type {function(new:java.io.PrintWriter, (java.io.BufferedWriter|java.io.PrintStream|string))}
     */
    var PrintWriter = /** @type {function(new:java.io.PrintWriter, (java.io.BufferedWriter|java.io.PrintStream|string))} */ (Java.type("java.io.PrintWriter"));
    /**
     * @type {function(new:java.lang.StringBuilder, string=)}
     */
    var StringBuilder = /** @type {function(new:java.lang.StringBuilder, string=)} */ (Java.type("java.lang.StringBuilder"));
