...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['require', './global', './bitset'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require, require('./global'), require('./bitset'));
    } else {
        root.nfaStates = factory(root.require, root.global, root.bitset);
    }
