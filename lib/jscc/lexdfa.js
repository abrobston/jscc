...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.lexdfa = factory(root.global, root.log);
    }
    ...
    var exports = {
        /**
         * Creates a new {@link module:jscc/global.Dfa} object and
         * adds it to the provided array.
         * @param {Array.<module:jscc/global.Dfa>} where - The array to which to add the
         * new Dfa object.
         * @returns {number} The prior length of the provided array.
         * @memberof module:jscc/lexdfa
         */
         ...
         * Dfa object whose {@link module:./global.Dfa.nfa_set}
         * property contains the same values as those in the
         * items parameter.
         * @param {Array.<module:jscc/global.Dfa>} dfa_states - The array of Dfa
         * objects to check.
         ...
         * whose {@link module:jscc/global.Dfa.done} value is false.
         * @param {Array.<module:jscc/global.Dfa>} dfa_states - The array to check.
         ...
         * @param {Array.<module:jscc/global.Nfa>} machine - The NFA state machine.
        ...
        move: function(state_set, machine, ch) {
            ...
            try {
                do {
                    tos = state_set.pop();
                    if (machine[tos].edge == global.EDGE_CHAR) {
        ...
        epsilon_closure: function(state_set, machine) {
            ...
            do {
                ...
                if (machine[tos].edge == global.EDGE_EPSILON) {
         ...
         * @param {Array.<module:jscc/global.Nfa>} nfa_states - The NFA-state machine
         * on which base the DFA will be constructed.
         * @returns {Array.<module:jscc/global.Dfa>} An array of DFA-objects forming the
        ...
        create_subset: function(nfa_states) {
            var dfa_states = [];
            var stack = [0];
            var current = exports.create_dfa(dfa_states);
            var trans;
            var next = -1;
            var lowest_weight;
            ...
            exports.epsilon_closure(stack, nfa_states);
            dfa_states[current].nfa_set = dfa_states[current].nfa_set.concat(stack);
            while ((current = exports.get_undone_dfa(dfa_states)) > -1) {
                ...
                for (var i = global.MIN_CHAR; i < global.MAX_CHAR; i++) {
                    ...
                    trans = exports.move(trans, nfa_states, i);

                    if (trans.length > 0) {
                        exports.epsilon_closure(trans, nfa_states);
                    }

                    if (trans.length == 0) {
                        next = -1;
                    } else if ((next = exports.same_nfa_items(dfa_states, trans)) == -1) {
                        next = exports.create_dfa(dfa_states);
         ...
         * @param {Array.<module:jscc/global.Dfa>} dfa_states - The DFA-state machine on
