...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './io/io', './enums/MODE_GEN', './enums/SYM', './enums/ASSOC'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports =
            factory(require('./global'), require('./io/ioNode'), require('./enums/MODE_GEN'),
                    require('./enums/SYM'), require('./enums/ASSOC'));
    } else {
        root.debug = factory(root.global, root.io, root.MODE_GEN, root.SYM, root.ASSOC);
    }
