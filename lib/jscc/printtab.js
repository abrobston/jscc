...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './tabgen', './log/log', './enums/MODE_GEN', './enums/SYM', './enums/SPECIAL'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports =
            factory(require('./global'), require('./tabgen'), require('./log/logNode'), require('./enums/MODE_GEN'),
                    require('./enums/SYM'), require('./enums/SPECIAL'));
    } else {
        root.printtab =
            factory(root.global, root.tabgen, root.log, root.MODE_GEN, root.SYM, root.SPECIAL);
    }
