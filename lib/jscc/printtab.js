...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './tabgen', './log/log'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('./global'), require('./tabgen'), require('./log/log'));
    } else {
        root.printtab = factory(root.global, root.tabgen, root.log);
    }
