...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './tabgen', './log/log', './enums/MODE_GEN', './enums/SYM', './enums/SPECIAL',
                './namespace'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports =
            factory(require('./global'), require('./tabgen'), require('./log/log'), require('./enums/MODE_GEN'),
                    require('./enums/SYM'), require('./enums/SPECIAL'), require('./namespace'));
    } else {
        root.printtab =
            factory(root.global, root.tabgen, root.log, root.MODE_GEN, root.SYM, root.SPECIAL, root.namespace);
    }
