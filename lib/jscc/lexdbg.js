...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['./global', './io/io', './bitset', './enums/EDGE', './namespace'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('./global'), require('./io/io'), require('./bitset'), require('./enums/EDGE'),
                                 require('./namespace'));
    } else {
        root.lexdbg = factory(root.global, root.io, root.bitset, root.EDGE, root.namespace);
    }
    ...
    jscc.lexdbg.prototype = {
        ...
        print_nfa: function() {
            ...
            for (var i = 0; i < global.nfa_states.length; i++) {
                io._print(i + "\t" + ((global.nfa_states[i].edge == EDGE.FREE) ? "FREE" :
